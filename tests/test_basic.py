...
def test_selection_result_model():
    ...
    result = SelectionResult(
        url="https://example.edu/staff", confidence="high", reasoning="Official school domain"
    )
...
def test_build_queries():
    ...
    school = School(
        name="Lincoln High School", district="Lincoln USD", county="", city="Lincoln", state="CA"
    )
